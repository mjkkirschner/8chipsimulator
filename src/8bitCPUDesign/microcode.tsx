...
export class microCodeData {
    ...
    static getData(): number[] {
        ...
        let microCodeData: number[] = [
            ...
            MEMORYREGIN | COUNTEROUT, RAMOUT | INSTRIN | COUNTERENABLE, MEMORYREGIN | COUNTEROUT, RAMOUT | COM_CONTROL_IN | COUNTERENABLE, 0, 0, 0, 0,                                //0001x0000 LOADCONTROLIMMEDIATE
            MEMORYREGIN | COUNTEROUT, RAMOUT | INSTRIN | COUNTERENABLE, MEMORYREGIN | COUNTEROUT, RAMOUT | MEMORYREGIN, RAMIN | COM_STATUS_OUT | COUNTERENABLE, 0, 0, 0,              //0001x0001 STORE COM STATUS
            MEMORYREGIN | COUNTEROUT, RAMOUT | INSTRIN | COUNTERENABLE, MEMORYREGIN | COUNTEROUT, RAMOUT | MEMORYREGIN, RAMIN | COM_DATA_OUT | COUNTERENABLE, 0, 0, 0,                //0001x0010 STORE COM DATA
            MEMORYREGIN | COUNTEROUT, RAMOUT | INSTRIN | COUNTERENABLE, MEMORYREGIN | COUNTEROUT, RAMOUT | MEMORYREGIN, RAMOUT | MEMORYREGIN, RAMIN | AOUT | COUNTERENABLE, 0, 0,     //0001x0011 STORE A AT POINTER

            MEMORYREGIN | COUNTEROUT, RAMOUT | INSTRIN | COUNTERENABLE, MEMORYREGIN | COUNTEROUT, RAMOUT | MEMORYREGIN, RAMOUT | MEMORYREGIN, RAMOUT | AIN | COUNTERENABLE, 0, 0,     //0001x0100 LOAD A AT POINTER

            //more math ops
            MEMORYREGIN | COUNTEROUT, RAMOUT | INSTRIN | COUNTERENABLE, MEMORYREGIN | COUNTEROUT, RAMOUT | MEMORYREGIN, RAMOUT | B_IN | COUNTERENABLE, SUMOUT | AIN | MULTIPLY, 0, 0,      //0001x0101 MULTIPLY
            MEMORYREGIN | COUNTEROUT, RAMOUT | INSTRIN | COUNTERENABLE, MEMORYREGIN | COUNTEROUT, RAMOUT | MEMORYREGIN, RAMOUT | B_IN | COUNTERENABLE, SUMOUT | AIN | DIVIDE, 0, 0,      //0001x0110 DIVIDE
            MEMORYREGIN | COUNTEROUT, RAMOUT | INSTRIN | COUNTERENABLE, MEMORYREGIN | COUNTEROUT, RAMOUT | MEMORYREGIN, RAMOUT | B_IN | COUNTERENABLE, SUMOUT | AIN | MOD, 0, 0,      //0001x0111 MODULO



        ];

        return microCodeData.map(x => x >>> 0);
    }
}